...
* @{
*/
#define GPIO_KEY_NUM                            3                           ///< 瀹氫箟鎸夐敭鎴愬憳鎬绘暟
...
{
    GIZWITS_LOG("####1 key2 long press, airlink mode\n");
...
* @return none
*/
LOCAL void ICACHE_FLASH_ATTR flow1ShortPress(void)
{
   // GIZWITS_LOG("#### flow1ShortPress \n");
}
...
* @return none
*/
LOCAL void ICACHE_FLASH_ATTR flow1LongPress(void)
{
   // GIZWITS_LOG("#### flow1LongPress\n");
}
...
* @return none
*/
LOCAL void ICACHE_FLASH_ATTR flow2ShortPress(void)
{
   // GIZWITS_LOG("#### flow2ShortPress\n");
    realPulse++;
    totalPulse++;
}
...
* @return none
*/
LOCAL void ICACHE_FLASH_ATTR flow2LongPress(void)
{
   // GIZWITS_LOG("#### flow2LongPress\n");
    realPulse++;
    totalPulse++;
}
...
LOCAL void ICACHE_FLASH_ATTR keyInit(void)
{
    ...
    //                             key2LongPress, key2ShortPress);
     ...
     singleKey[1] = keyInitOne(FLOW_1_IO_NUM, FLOW_1_IO_MUX, FLOW_1_IO_FUNC,
                                 flow1ShortPress, flow1LongPress);
     singleKey[2] = keyInitOne(FLOW_3_IO_NUM, FLOW_3_IO_MUX, FLOW_3_IO_FUNC,
                                 flow2ShortPress, flow2LongPress);
    // GPIO_DIS_OUTPUT(GPIO_ID_PIN(FLOW_1_IO_NUM));
    // GPIO_DIS_OUTPUT(GPIO_ID_PIN(FLOW_3_IO_NUM)); 
