...
* @{
*/
#define PRODUCT_KEY "a77dae99593749768614f75bf008e301"
/**@} */
/**@name Product Secret (Product key)
* @{
*/
#define PRODUCT_SECRET "163e269094db474189b409672e76a49d"
...
#define Motor_LEN                           1
#define Motor_Spare_BYTEOFFSET                    0
#define Motor_Spare_BITOFFSET                     1
#define Motor_Spare_LEN                           1
#define Flow_clean_BYTEOFFSET                    0
#define Flow_clean_BITOFFSET                     2
#define Flow_clean_LEN                           1
#define Liquid_BYTEOFFSET                    1
#define Liquid_BITOFFSET                     0
#define Liquid_LEN                           2
...
#define cumulative_flow_RATIO                         1
#define cumulative_flow_ADDITION                      0
#define cumulative_flow_MIN                           0
#define cumulative_flow_MAX                           99999999
/**@} */
...
typedef struct {
  bool valueMotor;
  bool valueMotor_Spare;
  bool valueFlow_clean;
  uint32_t valueLiquid;
  float valueSpeed;
  uint32_t valuecumulative_flow;
} dataPoint_t;
...
typedef struct {
  uint8_t flagMotor:1;
  uint8_t flagMotor_Spare:1;
  uint8_t flagFlow_clean:1;
} attrFlags_t;
